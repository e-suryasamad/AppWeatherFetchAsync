  ...
  async getWeather() {
    try {
      let response = await fetch(
        'http://api.openweathermap.org/data/2.5/weather?q=' + this.state.city + '&appid=4a7d94da5c6030e062d33ee671c5227a&units=metric'
      );
  ...
  render() {
    return (<View style={styles.containerMain}>
      <View style={styles.box1}>
          <Text style={{ textAlign: 'center', padding: 30, color: 'white', fontSize: 25 }} >Prakiraan Cuaca</Text>
      </View>
      <View style={styles.box2}>
          <Text style={{ textAlign: 'center', marginTop: 10, fontSize: 20 }}> Masukan Nama Kota </Text>
          <TextInput
              style={{ height: 40, width: 150, padding: 10, backgroundColor: 'white' }}
      ...
      <View style={styles.box5}>
          <Text style={{ textAlign: 'center', padding: 20, fontSize: 20, color: 'white' }}>Click Me</Text>
      </View>
</View>
    );
  }
